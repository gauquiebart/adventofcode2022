...
const countSand = function (cave) {
    return cave
        .reduce((accumulator, currentRow) =>
                accumulator + currentRow.reduce((accumulator, currentValue) => {
                        return accumulator + (currentValue === SAND ? 1 : 0);
                    }, 0
                ),
            0
        )
...
const puzzleInput = `521,154 -> 526,154
